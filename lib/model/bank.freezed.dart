...
abstract class $BankCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String logoImagePath});
}
...
class _$BankImpl implements _Bank {
  _$BankImpl(
      {required this.id, required this.name, required this.logoImagePath});
  ...
  @override
  String toString() {
    return 'Bank(id: $id, name: $name, logoImagePath: $logoImagePath)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, logoImagePath);
...
abstract class _Bank implements Bank {
  factory _Bank(
      ...
      required final String logoImagePath}) = _$BankImpl;
